...
- O que são EndPoints? Em (http://localhost:3000/clients) >> EndPoint é o "/clients"

### Parâmetros

- O que são Parâmetros? Em (http://localhost:3000/clients:id) >> Parâmetros é o ":id"

### Resource

-Um objeto e também entidade, ele tem dados associados a ele, tem relacionamento com outros "Resource" e também uma série de métodos para o operar
